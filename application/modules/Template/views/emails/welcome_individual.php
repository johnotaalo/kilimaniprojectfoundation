...
<p>Your membership has been confirmed for one calendar year from the date of this letter.  <span style = 'display: none;'>​Attached in PDF below is your membership card, which you ​may print and keep with you.</span></p>
...
<p>We look forward to getting to know you and engaging in community building together.</p>
<?php
	$data['contacts'] = true;
?>
